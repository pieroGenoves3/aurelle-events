...
export const de = {
  ...
  hero: {
    ...
    contactSubtitle: "Bereit, Ihre Reise zu beginnen? Kontaktieren Sie uns heute und lassen Sie uns besprechen, wie wir Ihnen helfen können, Ihre Ziele zu erreichen.",
