  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto px-4 animate-fade-in-up">
        ...
        <p className="text-xl md:text-2xl text-aurelle-dark-green font-light max-w-2xl mx-auto leading-relaxed drop-shadow-2xl mb-8 filter brightness-110 opacity-100">
          {content.subtitle}
        </p>
        <button
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        <div className="animate-bounce">
          <div className="w-6 h-10 border-2 border-aurelle-brown/40 rounded-full flex justify-center drop-shadow-lg">
            <div className="w-1 h-3 bg-aurelle-brown rounded-full mt-2 animate-pulse" />
          </div>
        </div>
      </div>
    </section>
