...
import { Mail, Phone, MapPin, Send, icons } from 'lucide-react';
...
const HeroSection = () => {
  ...
  const mottosContent = useContent<MottosContent>('mottos');
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col">
        ...
        {/* Philosophy Section */}
        {mottosContent && mottosContent.enabled && (
          <div className="py-24 px-4" style={{ backgroundColor: 'hsl(var(--aurelle-champagne))' }}>
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16 scroll-reveal">
                ...
                <p className="text-xl text-aurelle-black/80 max-w-2xl mx-auto opacity-100">
                  {mottosContent.subtitle}
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {mottosContent.items.map((motto, index) => {
